...
右尾高漂移词则需要进一步区分低频专名造成的估计不稳定与真实语料差异。剔除低频专名后保留下来的
“乙烯”“猛戳”“南都”“电焊工”“黑子”等词，更可能反映新闻语体与社交媒体语体在话题分布、表达习惯
和词语使用场景上的差别。因此，本文将词级余弦漂移理解为\textbf{跨语料用法差异的候选信号}，而不是单词语义变化的直接结论。
...
\subsubsection{现实解释}
较低的邻域Jaccard重合度说明，人民日报语料与微博语料中的词语差异并不只是表现为单个向量方向上的偏移，
还体现在具体近邻词集合的重新组合上。也就是说，同一个词在两个语料中可能仍然保持相近的总体语义位置，
但它实际连接的高相关词、常见搭配词和语境关联词已经发生变化。人民日报中的词语使用更容易受到正式表达、政策叙事和规范书面语的影响，
而微博中的词语使用更容易受到日常表达、热点事件和情绪化语境的影响。因此，$J_k(w)$ 的结果可以帮助我们从词级角度观察某个词在不同
语料环境中的语义邻域是否稳定，并为后续解释词义偏移来源提供依据。
